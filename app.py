...
# قراءة البيانات من ملف CSV مع التحقق من الأخطاء
try:
...
# التحقق من القيم المفقودة أو غير الصالحة
...
# تجميع البيانات حسب السنة والشهر (مع استخدام ذاكرة مؤقتة)
...
# جعل كائن خادم Flask متاحًا لـ Gunicorn
server = app.server

# قاموس لدعم اللغات المتعددة
translations = {
    'ar': {
...
app.layout = html.Div([
    ...
    # حاوية الرسوم البيانية الأولى (خطي وعمودي)
    dbc.Container([
        dbc.Row([
            dbc.Col([
    ...
    # حاوية الرسوم البيانية الثانية (دائري ومبعثر)
    dbc.Container([
        dbc.Row([
            dbc.Col([
...
# دالة التحديث للرسم البياني الخطي
@app.callback(
...
# دالة التحديث للرسم البياني العمودي
@app.callback(
...
# دالة التحديث للرسم البياني الدائري
@app.callback(
...
# دالة التحديث للرسم البياني المبعثر
@app.callback(
